 ...
 */
std::vector<char> bwt::iCharBwt(const std::vector<char> &encoded_bwt, const size_t key) {
  ...
  for(size_t i = 0; i < n; i++) {
    ...
    size_t effective_offset = (curr_offset > key_offset) ? curr_offset - 1 : curr_offset;
